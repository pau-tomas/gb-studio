...
watchProject(projectPath, {
  ...
  onAddTileset: (f) => store.dispatch(projectActions.loadTileset(f)),
  ...
  onChangedTileset: (f) => store.dispatch(projectActions.loadTileset(f)),  
  ...
  onRemoveTileset: (f) => store.dispatch(projectActions.removeTileset(f)),  
